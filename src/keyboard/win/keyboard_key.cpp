...
uint32_t keyboardKeyToNativeKey(KeyboardKey key) noexcept
{
    ...
    switch (key)
    {
        ...
        case KBDKEY_CTRL_LEFT:          return VK_LCONTROL;
        case KBDKEY_CTRL_RIGHT:         return VK_RCONTROL;
        case KBDKEY_ALT:                return VK_MENU;
        case KBDKEY_ALT_LEFT:           return VK_LMENU;
        case KBDKEY_ALT_RIGHT:          return VK_RMENU;
        case KBDKEY_SHIFT:              return VK_SHIFT;
...
KeyboardKey keyboardKeyFromNativeKey(uint32_t nativeKey) noexcept
{
    ...
    switch (nativeKey)
    {
        ...
        // Modifier keys
        case VK_LWIN:                   return KBDKEY_META_LEFT;
        case VK_RWIN:                   return KBDKEY_META_RIGHT;
        case VK_CONTROL:                return KBDKEY_CTRL;
        case VK_LCONTROL:               return KBDKEY_CTRL_LEFT;
        case VK_RCONTROL:               return KBDKEY_CTRL_RIGHT;
        case VK_MENU:                   return KBDKEY_ALT;
        case VK_LMENU:                  return KBDKEY_ALT_LEFT;
        case VK_RMENU:                  return KBDKEY_ALT_RIGHT;
        case VK_SHIFT:                  return KBDKEY_SHIFT;
        case VK_LSHIFT:                 return KBDKEY_SHIFT_LEFT;
        case VK_RSHIFT:                 return KBDKEY_SHIFT_RIGHT;
