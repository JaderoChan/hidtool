...
KeyboardKey keyboardKeyFromNativeKey(int32_t nativeKey) noexcept
{
    switch (nativeKey)
    {
        ...
        // Modifiers keys
        case kVK_Function:              return KBDKEY_FUNCTION;
        case kVK_Command:               return KBDKEY_META;
        case kVK_RightCommand:          return KBDKEY_META_RIGHT;
        case kVK_Control:               return KBDKEY_CTRL;
        case kVK_RightControl:          return KBDKEY_CTRL_RIGHT;
        case kVK_Option:                return KBDKEY_ALT;
        case kVK_RightOption:           return KBDKEY_ALT_RIGHT;
        case kVK_Shift:                 return KBDKEY_SHIFT;
        case kVK_RightShift:            return KBDKEY_SHIFT_RIGHT;
